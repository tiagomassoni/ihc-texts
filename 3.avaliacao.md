...
No meio dos anos 80, Ben Shneiderman também propôs um conjunto de diretrizes que são frequentemente usadas como heurística para avaliação, as **regras de ouro** (_eight golden rules_). São definidas assim, depois de uma revisão de 2016:
